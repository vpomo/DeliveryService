...
public class ResponseOrderCDEK {
/*
          "<Order
...
*/
    ...
    private List<AddedServiceOrderCDEK> addService;
    ...
    public List<AddedServiceOrderCDEK> getAddService() {
        return addService;
    }

    public void setAddService(List<AddedServiceOrderCDEK> addService) {
        this.addService = addService;
    }

    @Override
    public String toString() {
        return ("ResponseOrderCDEK={numberOrder=" + numberOrder + ", dispatchNumberOrder=" + dispatchNumberOrder+ "}");
    }
}
